...
// the full palette). Listed light-to-dark, three of each — all calm, muted
// palettes rather than anything high-contrast or bright.
...
export const THEMES: ThemeOption[] = [
  ...
  { id: "forest", label: "Forest Library", swatch: ["#eef2e9", "#3a6444"] },
  { id: "misty", label: "Misty Harbor", swatch: ["#e8edef", "#3e707c"] },
  { id: "midnight", label: "Midnight Study", swatch: ["#161921", "#be9459"] },
  { id: "evergreen", label: "Evergreen Night", swatch: ["#121712", "#80a379"] },
  { id: "twilight", label: "Twilight Plum", swatch: ["#19151d", "#a484a8"] },
];
